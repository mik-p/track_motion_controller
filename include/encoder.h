...
public:
  ...
  void set_encoder_pulses(int32_t pulses) {_encoder_pulses = pulses;}
  int32_t get_pulses() {return _encoder_pulses;}
  ...
  double get_velocity(double disp, double delta_t); // calculate velocity given disp & timestep
